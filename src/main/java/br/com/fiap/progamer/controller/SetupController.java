...
public class SetupController {
	...
	public ResponseEntity<String> create(@RequestBody SetupModel setupRequest) {
		...
		try {
			if (setupRequest.getName() == null || setupRequest.getDescription() == null || setupRequest.getGames() == null
					|| setupRequest.getPrice() <= 0
			...
			setup.setGames(setupRequest.getGames());
